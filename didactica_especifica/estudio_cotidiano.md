## Estudio Cotidiano {#estudio-cotidiano}
...
Aprender a relajar los músculos que no se utilizan y usar solamente los necesarios, hará que el alumno-instrumentista pueda interpretar con mayor libertad y sin fatiga durante períodos de tiempo más largos.

La contracción muscular crónica es una de las consecuencias de la tensión continuada. El investigador Hans Selye (1936) comprobó el efecto destructor del stress cuando es crónico y su última etapa es el agotamiento, porque en ese momento el cuerpo agota las energías para contrarrestar la tensión y luego aparece la fatiga.
